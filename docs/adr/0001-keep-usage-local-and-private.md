...
QuotaPeek derives provider usage from local Codex and Claude Code records and
does not read prompt or response text, access credentials, or send analytics.
